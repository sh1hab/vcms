        ...
        <table class="table table-striped">
            ...
            @for( $i=0;$i< count($noti_list);$i++ )
                ...
                <tr>
                    ...
                    <td>img</td>
                    <td>{{$noti_list[$i]->s_name}} <br>{{$noti_list[$i]->s_dept}},{{$noti_list[$i]->s_varsity}}
                        <br>{{$noti_list[$i]->s_term}}</td>
                    <td>

                        <a class="btn btn-primary"
                           href="{{url('accept_rqst')}}/{{$noti_list[$i]->srl}}/{{$noti_list[$i]->r_sts}}">Accept</a>
